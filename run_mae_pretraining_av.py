...
def get_args():
    ...
    parser.add_argument('--mask_type', default='tube', choices=['random', 'tube', 'part_window'], type=str, help='masked strategy of video tokens/patches')
...
def get_model(args):
    print(f"NOTE: -> Creating model with LGBlock and Dual Masking: {args.model}")
    ...
    model = create_model(
        ...
        attn_type=args.attn_type, lg_region_size=args.lg_region_size, lg_region_size_audio=args.lg_region_size_audio, lg_first_attn_type=args.lg_first_attn_type,
