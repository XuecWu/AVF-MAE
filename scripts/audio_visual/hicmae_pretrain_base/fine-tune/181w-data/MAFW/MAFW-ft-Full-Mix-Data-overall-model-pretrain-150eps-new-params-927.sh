server=6000
pretrain_dataset='full-mix-data-final-model-pretrain-150eps-new-params-927'
...
do
  ...
  do
    ...
    MODEL_PATH="./saved/model/pretraining-base-mix-data-overall-181w-final-model-renew-parms-919/audio_visual/AVF-MAE++_pretrain_base/checkpoint-${ckpt}.pth"
