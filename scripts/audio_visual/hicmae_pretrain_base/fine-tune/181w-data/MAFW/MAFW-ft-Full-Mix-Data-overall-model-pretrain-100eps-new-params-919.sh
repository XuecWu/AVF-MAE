server=6000
pretrain_dataset='full-mix-data-final-model-pretrain-100eps-new-params-919'
...
do
  ...
  do
    ...
    MODEL_PATH="./saved/model/pretraining-base-mix-data-overall-181w-final-model-new-parms-914/audio_visual/AVF-MAE++_pretrain_base/checkpoint-${ckpt}.pth"
