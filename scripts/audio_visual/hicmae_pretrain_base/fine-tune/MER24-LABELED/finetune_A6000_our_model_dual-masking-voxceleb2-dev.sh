server=6000
pretrain_dataset='voxceleb2-dev'
...
do
  ...
  do
    ...
    MODEL_PATH="./saved/model/pretraining/voxceleb2-dev_LGBlock-Dual-Masking-no-compile/audio_visual/${model_dir}/checkpoint-${ckpt}.pth"
