...
OUTPUT_DIR="./saved/model/pretraining-mix-data-109w-four-parts_LGBlock-Dual-Masking-no-compile-both-local-atts-MMPM-fusion-no-masks-726/audio_visual/${model}"
