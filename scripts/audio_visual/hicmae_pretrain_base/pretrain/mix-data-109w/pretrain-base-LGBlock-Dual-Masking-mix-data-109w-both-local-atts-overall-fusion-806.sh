...
OUTPUT_DIR="./saved/model/pretraining-mix-data-109w-four-parts_LGBlock-Dual-Masking-no-compile-both-local-atts-overall-fusion-no-TL-no-share/audio_visual/${model}"
