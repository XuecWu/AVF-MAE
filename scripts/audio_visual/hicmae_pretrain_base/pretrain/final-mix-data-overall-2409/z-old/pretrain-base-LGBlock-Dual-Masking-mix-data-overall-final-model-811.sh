...
OUTPUT_DIR="./saved/model/pretrain-base-model-LGBlock-Dual-Masking-mix-data-overall-final-model-811/audio_visual/${model}"
if [ ! -d "$OUTPUT_DIR" ]; then
  mkdir -p $OUTPUT_DIR
fi

DATA_PATH='./saved/data/mix-data-final-2408/audio_visual/final-overall-181w-2408.csv'
