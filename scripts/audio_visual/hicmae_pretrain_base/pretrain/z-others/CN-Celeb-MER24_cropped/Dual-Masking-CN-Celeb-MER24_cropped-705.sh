...
OUTPUT_DIR="./saved/model/pretraining-test-dual-masking-705/CN-Celeb-MER24-cropped/audio_visual/${model}"
if [ ! -d "$OUTPUT_DIR" ]; then
  mkdir -p $OUTPUT_DIR
fi

DATA_PATH='./saved/data/CN-Celeb-MER24-cropped/audio_visual/CN-Celeb-MER24-cropped_av_pretrain.csv'
