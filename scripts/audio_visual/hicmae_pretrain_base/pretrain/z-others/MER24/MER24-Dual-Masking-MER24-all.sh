...
OUTPUT_DIR="./saved/model/pretraining-test-dual-masking-all-MER24-705/MER24-pretrain-cropped/audio_visual/${model}"
if [ ! -d "$OUTPUT_DIR" ]; then
  mkdir -p $OUTPUT_DIR
fi

DATA_PATH='./saved/data/MER24_pretrained_cropped/MER24-cropped-av-pretrain.csv'
