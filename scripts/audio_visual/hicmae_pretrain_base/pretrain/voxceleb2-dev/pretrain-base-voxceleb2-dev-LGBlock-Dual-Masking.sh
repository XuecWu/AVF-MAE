...
OUTPUT_DIR="./saved/model/pretraining/voxceleb2-dev_LGBlock-Dual-Masking-no-compile/audio_visual/${model}"
if [ ! -d "$OUTPUT_DIR" ]; then
  mkdir -p $OUTPUT_DIR
fi

DATA_PATH='./saved/data/voxceleb2/audio_visual/voxceleb2-uncompressed-av-pretrain.csv'
