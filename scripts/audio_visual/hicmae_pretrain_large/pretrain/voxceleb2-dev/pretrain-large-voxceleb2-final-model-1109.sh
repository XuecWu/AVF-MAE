model="AVF-MAE++_pretrain_large"
OUTPUT_DIR="./saved/model/1109-ablation-pretraining-large-model-voxceleb2-dev/audio_visual/${model}"
if [ ! -d "$OUTPUT_DIR" ]; then
  mkdir -p $OUTPUT_DIR
fi

DATA_PATH='./saved/data/voxceleb2_CNCVS/audio_visual/voxceleb2-CNCVS-av-pretrain.csv'
