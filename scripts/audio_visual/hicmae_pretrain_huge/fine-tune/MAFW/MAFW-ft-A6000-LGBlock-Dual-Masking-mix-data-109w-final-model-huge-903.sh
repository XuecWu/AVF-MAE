server=6000
pretrain_dataset='mix-data-109w-pretrain-100eps-final-model-huge-903'
finetune_dataset='MAFW'
num_labels=11
model_dir="hicmae_pretrain_huge"
ckpts=(99)
input_size=160
...
do
  ...
  do
    ...
    MODEL_PATH="./saved/model/pretraining-mix-data-109w-four-parts_final-model-huge-831-new/audio_visual/${model_dir}/checkpoint-${ckpt}.pth"
    ...
    CHECKPOINT_FILE="${OUTPUT_DIR}/checkpoint-99.pth"
