...
OUTPUT_DIR="./saved/model/AAA-TEST-831-pretraining-mix-data-109w-four-parts_final-model-huge-831/audio_visual/${model}"
if [ ! -d "$OUTPUT_DIR" ]; then
  mkdir -p $OUTPUT_DIR
fi

DATA_PATH='./saved/data/mix-data/voxceleb2_CNCVS-CN-Celeb-MER24-pretrain-cropped-AVspeech-Final/audio_visual/debug-5w.csv'
