...
dataset    = "MSD-Wild-DB"
data_path  = os.path.expanduser(f'./datasets/new-pretrain-datasets-4parts-2408/{dataset}')
...
for split in splits:
    ...
    save_dir = f'./saved/data/new-pretrain-datasets-4parts-2408/MSD-Wild-DB/audio_visual'
    ...
    new_train_split_file = os.path.join(save_dir, f'MSD-Wild-DB-av-pretrain.csv')
