...
labels    = ['worried', 'happy', 'neutral', 'angry', 'surprise', 'sad']
...
for split in splits:
    ...
    save_dir = f'./saved/data/mer24-labeled/audio_visual/split0{split}'
